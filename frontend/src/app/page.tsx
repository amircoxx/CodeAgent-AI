    ...
    <main className="code-grid min-h-screen px-4 py-6 sm:px-6 lg:px-8">
      <div className="relative mx-auto flex max-w-7xl flex-col gap-7">
        <header className="ledger-panel rounded-md">
          <div className="relative z-30 flex flex-col gap-5 border-b border-[#25251e] bg-[#fffdf8]/72 px-5 py-5 lg:flex-row lg:items-end lg:justify-between sm:px-7">
          ...
          <div className="relative z-0 grid gap-px bg-[#25251e] text-xs font-extrabold uppercase tracking-[0.14em] text-[#4f4b41] sm:grid-cols-3">
